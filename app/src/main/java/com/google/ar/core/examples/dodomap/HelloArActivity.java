...
import com.google.ar.core.examples.dodomap.common.helpers.*;
import com.google.ar.core.examples.dodomap.common.samplerender.*;
import com.google.ar.core.examples.dodomap.common.samplerender.Mesh;
import com.google.ar.core.examples.dodomap.common.samplerender.Mesh.PrimitiveMode;
import com.google.ar.core.examples.dodomap.common.samplerender.arcore.*;
import com.google.ar.core.exceptions.*;
import com.google.ar.core.examples.dodomap.managers.*;
...
public class HelloArActivity extends AppCompatActivity implements SampleRender.Renderer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnAreaReport = findViewById(R.id.btnAreaReport);
...
//  private long lastCaptureTime = 0;
    ...
    private void pollQualityStatus(String imageId, int cellIndex) {
        new Thread(() -> {
            ...
            while (attempt < maxAttempts) {
                try {
                    ...
                    if ("completed".equals(status)) {
                        // Processing complete - calculate area
                        ...
                        runOnUiThread(() ->
                                Toast.makeText(this, "Server error processing image",
                                        Toast.LENGTH_SHORT).show()
                        );
                        break;
                    }
            ...
            if (attempt >= maxAttempts) {
                Log.e("Poll", "Polling timeout");
                runOnUiThread(() ->
                        Toast.makeText(this, "Processing timeout", Toast.LENGTH_SHORT).show()
                );
            }
        }).start();
    }
    ...
    private void drawSingleCell(GridManager.GridCell cell,
                                com.google.ar.core.examples.dodomap.common.samplerender.Shader shader,
                                float[] color) {
        try {
